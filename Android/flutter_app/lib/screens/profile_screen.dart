      ...
      body: SafeArea(
        child: FutureBuilder<void>(
          ...
          builder: (context, snapshot) {
            ...
            final name = (_profile?['name'] as String? ?? 'Siti Aminah').trim();
            final phone = (_profile?['phone'] as String? ?? '-').trim();
            final role = (_profile?['role'] as String? ?? 'orang_tua').trim();
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SettingsCard(
                    ...
                    onToggleReminder: (v) => setState(() => _reminderEnabled = v),
                    onPickTime: () async {
                    ...
                    onTapAccount: () => Navigator.of(context).push(
                      fadeRoute(const AccountInfoScreen()),
                    ),
    ...
    return HealthCard(
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Notifikasi & Pengingat', style: AppTypography.h3),
                      const SizedBox(height: 2),
                      Text(
                        'Reminder timbang, update data, dan nutrisi',
                        style: AppTypography.caption,
                      ),
                    ],
                  ),
                ...
                Switch(
                  ...
                  activeColor: const Color(0xFF0B7A86),
                ),
              ],
            ),
          ),
          AnimatedCrossFade(
            duration: const Duration(milliseconds: 220),
            crossFadeState: reminderEnabled
            ...
            firstChild: Padding(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0xFF7FD6C2).withValues(alpha: 0.16),
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(
                      color: const Color(0xFF7FD6C2).withValues(alpha: 0.35),
                    ),
                  ),
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Jam pengingat: ${_formatTime(reminderTime)}',
                          style: AppTypography.body.copyWith(
