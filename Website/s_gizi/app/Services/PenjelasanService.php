...
class PenjelasanService
{
    public function penjelasan(string $statusGabungan): string
    {
        return match ($statusGabungan) {
            ...
            'Stunting Berat' => 'TB/U sangat rendah (stunting berat). Perlu perbaikan kualitas asupan jangka panjang (protein hewani, mikronutrien) dan pantau tumbuh kembang.',
            'Stunting' => 'TB/U rendah (stunting). Tingkatkan kualitas asupan (protein hewani, zat besi, zinc) dan pastikan pola makan serta kebersihan baik.',
            'Stunting + Risiko Gizi Lebih' => 'Tinggi badan rendah tetapi BB/TB cenderung tinggi. Perbaiki kualitas makanan tanpa berlebihan kalori kosong, fokus protein dan mikronutrien.',
            ...
            'Risiko Gizi Lebih' => 'BB/TB mulai meningkat. Jaga pola makan seimbang dan porsi sesuai kebutuhan agar tidak berkembang menjadi gizi lebih.',
